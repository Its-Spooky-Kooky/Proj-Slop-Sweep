...
Powered by the robust reasoning capabilities of **Anthropic's Claude 3 Opus**, SlopSweep doesn't just give you a generic percentage score; it deeply analyzes the substance of the text.
...
1. **Opus-Level Reasoning:** Instead of relying on rigid statistical models, we use the most capable model available (Claude 3 Opus) to evaluate the text semantically. It looks for the hallmark signs of AI "slop"—overuse of transitional phrases, lack of concrete examples, robotic neutrality, and circular logic.
...
- **AI Engine:** Anthropic SDK (`claude-3-opus-20240229`)
